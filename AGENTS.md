...
- Micro Chat inner tab labels should use light Apple-system typography, not bold text; chat rows should show a visible delete action for local conversation history. Contacts should include "新的好友" and "群聊"; roles can proactively request to add the user, and accept/reject/request feedback should have a small delay.
