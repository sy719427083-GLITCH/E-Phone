...
- The bottom tab bar for home, roles, me, and settings should float slightly above the bottom edge instead of sitting flush against the home indicator area.
