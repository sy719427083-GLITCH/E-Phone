...
- Micro Chat inner tab labels should use light Apple-system typography, not bold text; chat rows should support left-swipe delete for local conversation history.
