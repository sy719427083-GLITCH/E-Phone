...
- Micro Chat "新的好友" should open its own WeChat-like page showing current and historical add requests. Moments should follow the real WeChat structure: a top wallpaper area, the user's own avatar overlapping the cover, and a plain white feed area below.
