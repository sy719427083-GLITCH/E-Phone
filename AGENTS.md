...
- Work app header should say "工作目录" instead of "5 个备选", and should not show a separate "可选线上或线下" helper sentence. The countdown line should still be a curve, but only gently curved, thin, long, and spanning almost the whole lower card width. The full-body cat progress marker should have a clean transparent PNG background and sit on the progress line from the initial 0% position.
