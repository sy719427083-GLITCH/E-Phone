...
- Latest lock-screen wallpaper direction is a pure-white fairy-tale city road with clean manga/comic feeling, low-saturation pink accents, and a small cat plus dog together near the bottom; avoid noisy texture and avoid green as the main color. The home wallpaper remains the pure-white windowsill cat with plant-depth direction.
