...
- On real phones or touch/narrow screens, every screen, wallpaper, lock screen, and in-app page should fill the viewport. On desktop browsers, keep a responsive phone-proportioned preview instead of stretching the UI across the full width.
