...
- The PWA manifest start URL should be an absolute `/E-Phone/` URL with a version query so iOS home-screen launches do not keep using an unversioned stale app shell.
